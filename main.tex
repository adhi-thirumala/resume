...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
		            ...
		            \textbf{Languages:}{ Python, Java, HTML, Bash, \LaTeX, YAML, TOML, SQL, Go, C, C++} \\

		            \textbf{Tools:}{ Git/GitHub, Github Actions, Vim, Huggingface, Linux, Maven, Gradle, SQlite, Docker}\\
		            % \textbf{Frameworks}{: React, Node.js, Flask, JUnit, WordPress, Material-UI, FastAPI} \\
		            \textbf{Libraries:}{ pandas, NumPy, Matplotlib, Tensorflow, pyTorch, Sci-Kit Learn, Swing (Java), Spring Boot (Java)}
...
{\textbf{matched.lol - In Progress} $|$ {\small\footnotesize\emph{Java, Go, SQLite}}}{September 2024 - Present}
\resumeItemListStart
\resumeItem{Lead backend developer for web/mobile application to match League of Legends players based on preference}
\resumeItem{Developed a RESTful API using Spring Boot and Go to handle user requests}
\resumeItem{Utilized SQLite to store user data and preferences}
...
\resumeItem{Coached five teams to first-time elimation round finishes and consistent national circuit tournament placements}
\resumeItemListEnd
\resumeSubHeadingListEnd
